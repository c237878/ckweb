...
export const actorApi = {
  ...
  /** 全站抓取：任务在服务端后台跑，这里只负责启动 / 看进度 / 停止 */
  startAvatarFetch: () => api.post('/actor/avatars/fetch'),
  avatarFetchStatus: () => api.get('/actor/avatars/fetch/status'),
  stopAvatarFetch: () => api.delete('/actor/avatars/fetch'),
  /** 疑似重复演员候选（按线索强度排序） */
